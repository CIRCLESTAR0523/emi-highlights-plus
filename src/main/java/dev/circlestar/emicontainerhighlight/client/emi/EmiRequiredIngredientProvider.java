package dev.circlestar.emicontainerhighlight.client.emi;

import dev.circlestar.emicontainerhighlight.EmiContainerHighlights;
import dev.circlestar.emicontainerhighlight.client.RequiredIngredientProvider;
    ...
    private Set<Slot> collectSuppressedSlots(AbstractContainerScreen<?> screen) {
        ...
        try {
            ...
            if (!handlerErrorLogged) {
                ...
                EmiContainerHighlights.LOGGER.warn(
